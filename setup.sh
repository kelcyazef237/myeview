...
echo "1. Open http://localhost:3000 and create your first administrator account via the Register page."
echo "2. Go to the Settings page in the Web UI to add your Shodan and Censys API keys for Advanced Scans."
