...
type Asset struct {
	...
	TargetID       string            `gorm:"not null;index" json:"target_id"` // e.g., "example.com"
	Name           string            `gorm:"not null;index" json:"name"`      // e.g., "api.example.com"
	Type           string            `gorm:"not null" json:"type"`            // "subdomain", "ip"
